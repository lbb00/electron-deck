...
// main.js's DECK_DEMO_PROFILE capture) and aggregates SELF time per function
...
//
// Usage: node profile-summary.js <path-to.cpuprofile>
...
if (!path) {
	console.error('usage: node profile-summary.js <path-to.cpuprofile>')
	process.exit(1)
}
