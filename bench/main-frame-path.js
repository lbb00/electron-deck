...
if (typeof globalThis.gc !== 'function') {
	console.error('bench/main-frame-path.js requires --expose-gc (heap deltas are meaningless without a forced GC baseline).')
	console.error('Usage: node --expose-gc bench/main-frame-path.js')
	console.error('       DIST=<path-to-dist>/layout node --expose-gc bench/main-frame-path.js   # bench another branch\'s build')
	process.exit(2)
}
